...
public class PaddleTestTwo extends Canvas implements KeyListener, Runnable
{
	...
	public void paint(Graphics window)
	{
		...
		if((ball.getX()-leftPaddle.getX())<=10&&(ball.getY()-leftPaddle.getY())<=60&&(ball.getY()-leftPaddle.getY())>=0||(rightPaddle.getX()-ball.getX())<=10&&(ball.getY()-rightPaddle.getY())<=60&&(ball.getY()-rightPaddle.getY())>=0){
